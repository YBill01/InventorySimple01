...
namespace YB.HFSM
{
	public abstract class State
	{
		...
		public Action AddEventTransition(State targetState, bool forced = false)
		{
			StateMachine commonStateMachine = GetCommonStateMachine(this, targetState);
			if (commonStateMachine != null)
			{
				StateEventTransition transition = new StateEventTransition(commonStateMachine, this, GetNearestTargetState(commonStateMachine, targetState), null, forced);
				_transitions.Add(transition);
		...
		public Action AddEventTransition(State targetState, Action transitionApplied, bool forced = false)
		{
			StateMachine commonStateMachine = GetCommonStateMachine(this, targetState);
			if (commonStateMachine != null)
			{
				StateEventTransition transition = new StateEventTransition(commonStateMachine, this, GetNearestTargetState(commonStateMachine, targetState), transitionApplied, forced);
				_transitions.Add(transition);
